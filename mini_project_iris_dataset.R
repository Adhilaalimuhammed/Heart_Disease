...
hist(df$Sepal.Length,main = "sepal length",xlab = "petal length",ylab = "frecuency",col='yellow')

hist(df$Sepal.Width,col='blue')

hist(df$Petal.Length,main = "Petal length",xlab = "petal length",ylab = "frecuecy",col="pink")

hist(df$Petal.Width,main = "Petal width",xlab = "petal length",ylab = "frecuency",col="red")
#--------------------------------------------------------------------------------------------------
