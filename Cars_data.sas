...
/*4: print all columns where make=acura,origin=asia---*/
proc sql;
	select * from cars where Make='Acura' and origin='Asia';
quit;

/*5 print make,type plot in bargraph*/
proc sql;
	select make, type from cars ;
quit;
...
run;
/*9: select all columns type= Audi  ande have cylinder>4*/
proc sql;
